...
#Find isoptope Numbers
        result = "Atomic Number:{} \nAbbreviation:{} \nAtomic Mass:{} u \nGroup:{} \nElements in same Group:{}  \nProtons:{} \nNeutrons:{} \nElectrons: {} \nMelting Point: {} °C \nBoiling Point:{} °C \nInert:{} \nState of matter at room temperature:{} \nDensity:{}kg/Meters Cubed \nColor:{} \nAtomic Radius:{} Pm \nRadioactive: {} \nMan Made:{}".format(Number,abrev,mass,group,Elementsinsamefamily,Number,Neutrons,Number,melt,boil,Inert,State,dence,color,radius,Radioactive,Manmade)
        return result
...
"Boron": form('5','B','10.81','Metalloids','2075','4000','2460','Black','87'), "Carbon": form('6','C','12.011','Reactive Nonmetals','3642','3642','2260','Black','67'), "Nitrogen": form('7','N','14.007','Reactive Nonmetals', '-210.1','-195.8','1.251','None','56'), "Oxygen": form('8',"O",'15.999','Reactive Nonmetals','-218','-183','1.429','None','48'),
    ...
    "Aluminum" : form('13','AL','26.982','Post Transition Metals','660.32','2519','2700','Silver','118'), "Silicon": form('14',"Si",'28.085','Metalloids','1414','2900','2330','Gray','111'), "Phosphorus": form('15','P','30.974','Reactive Nonmetals','44.15','280.5','1823','None','98'), "Sulfer": form('16','S','32.06','Reactive Nonmetals','115.21','444.72','1960','Yellow','88'), "Chlorine": form('17',"CL",'35.45','Reactive Nonmetals','-101.5','-34.040','3.214','Yellow','79'),
    ...
    'Astatine': form('85', 'At', '210', 'Metalloids', '302', '350', 'None', 'Silver', '127'),'Radon': form('86', 'Rn', '222', 'Noble Gases', '-71.1', '-68.85', '9.73', 'Colorless ', '120'),'Francium': form('87', 'Fr', '223', 'Alkali Metals', '20.9', '650', 'None', 'Silver-Gray-Metallic', 'None'),'Radium': form('88', 'Ra', '226', 'Alkaline Earth Metals', '700', '1737', '5000', 'Silver-WHite', 'None'),
